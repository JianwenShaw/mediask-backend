...
public class UpdateAdminDepartmentUseCase {
    ...
    @Transactional
    public AdminDepartmentDetail handle(UpdateAdminDepartmentCommand command, AuditContext auditContext) {
        AdminDepartmentDetail detail = adminDepartmentWriteRepository.update(
                command.id(),
                new AdminDepartmentUpdateDraft(
                        command.name(),
                        command.deptType(),
                        command.status(),
                        command.sortOrder()));
