...
public enum ScenarioCode {
    ...
    ADMIN_DOCTOR_LIST(ActionType.READ, CombinationMode.ALL, "admin:doctor:list", false, false),
    ADMIN_DOCTOR_VIEW(ActionType.READ, CombinationMode.ALL, "admin:doctor:view", false, false),
    ADMIN_DOCTOR_CREATE(ActionType.CREATE, CombinationMode.ALL, "admin:doctor:create", false, false),
    ADMIN_DOCTOR_UPDATE(ActionType.UPDATE, CombinationMode.ALL, "admin:doctor:update", false, false),
    ADMIN_DOCTOR_DELETE(ActionType.DELETE, CombinationMode.ALL, "admin:doctor:delete", false, false),
    ADMIN_DEPARTMENT_LIST(ActionType.READ, CombinationMode.ALL, "admin:department:list", false, false),
    ADMIN_DEPARTMENT_VIEW(ActionType.READ, CombinationMode.ALL, "admin:department:view", false, false),
    ADMIN_DEPARTMENT_CREATE(ActionType.CREATE, CombinationMode.ALL, "admin:department:create", false, false),
    ADMIN_DEPARTMENT_UPDATE(ActionType.UPDATE, CombinationMode.ALL, "admin:department:update", false, false),
    ADMIN_DEPARTMENT_DELETE(ActionType.DELETE, CombinationMode.ALL, "admin:department:delete", false, false),
    ...
    EMR_RECORD_LIST(ActionType.READ, CombinationMode.ALL, "emr:read", false, false),
    EMR_RECORD_READ(ActionType.READ, CombinationMode.ALL, "emr:read", true, false),
    EMR_RECORD_HISTORY_READ(ActionType.READ, CombinationMode.ALL, "emr:read", true, false),
    ...
    PRESCRIPTION_UPDATE(ActionType.UPDATE, CombinationMode.ALL, "prescription:update", true, false),
    PRESCRIPTION_ISSUE(ActionType.UPDATE, CombinationMode.ALL, "prescription:issue", true, false),
    PRESCRIPTION_CANCEL(ActionType.UPDATE, CombinationMode.ALL, "prescription:cancel", true, false),
