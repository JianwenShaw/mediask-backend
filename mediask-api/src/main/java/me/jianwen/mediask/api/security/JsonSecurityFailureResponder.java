...
final class JsonSecurityFailureResponder {

    private final ObjectMapper objectMapper;

    JsonSecurityFailureResponder(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    void writeInternalError(HttpServletRequest request, HttpServletResponse response, ErrorCodeType errorCode)
            throws IOException {
        ...
        objectMapper.writeValue(response.getOutputStream(), Result.<Void>fail(errorCode).withRequestId(requestId));
    }
